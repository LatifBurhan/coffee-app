    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a class="nav-link px-5 py-2 rounded-full text-sm font-medium text-gray-600 hover:text-emerald-700 hover:bg-emerald-50 transition-all duration-300" href="#reservation">Reservation</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 bg-white/90 backdrop-blur-xl rounded-2xl p-6 absolute left-4 right-4 shadow-2xl border border-white/20 transform origin-top animate-fade-in-down">
            <ul class="flex flex-col space-y-3 text-center">
                ...
                <li><a class="block py-2 text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg font-medium transition" href="#reservation">Reservation</a></li>
